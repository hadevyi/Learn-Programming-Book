...
public partial class Chapter_8_Update : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Cmd.Connection = conn;
        Cmd.CommandText = "UPDATE userdb SET mileage = " + TextBox2.Text + " WHERE id = '" + TextBox1.Text + "'";
        ...
        Label1.Text = "레코드가 성공적으로 UpDate 되었습니다!";
